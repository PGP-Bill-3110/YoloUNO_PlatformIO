...
String mainPage()
{
  ...
  String neo = neo_state ? "ON" : "OFF";
  String fsm = fsm_mode ? "ON" : "OFF";
  String tinyml = tinyml_mode ? "ON" : "OFF";
  ...
  <body>
    ...
    <div class="container">
      ...
      <div>
        ...
        <button onclick='toggleLED(2)'>💡 neo: <span id="l2">)rawliteral" +
         neo + R"rawliteral(</span></button>
      </div>

      <div>
        <button onclick='toggleLED(3)'>🎛️ FSM Mode: <span id="l3">)rawliteral" +
         fsm + R"rawliteral(</span></button>
        <button onclick='toggleLED(4)'>🌈 TinyML: <span id="l4">)rawliteral" +
         tinyml + R"rawliteral(</span></button>
      </div>
      ...
      function toggleLED(id) {
        fetch('/toggle?led='+id)
          ...
          .then(json=>{
            ...
            document.getElementById('l2').innerText=json.neo;
            if(json.fsm) document.getElementById('l3').innerText=json.fsm;
            if(json.tinyml) document.getElementById('l4').innerText=json.tinyml;
          });
      }
...
String settingsPage()
{
  ...
  <body>
    // <img src="data:image/png;base64," alt="Project Icon" class="logo">
    <div class="container">
...
void handleToggle()
{
  ...
  else if (led == 2)
  {
    ...
    // Update NeoPixel LED color based on state
    if (neoMutex && xSemaphoreTake(neoMutex, pdMS_TO_TICKS(200)) == pdTRUE) {
      if (neo_state) {
        // Turn on NeoPixel LED with blue color
        neoStrip.setPixelColor(0, neoStrip.Color(0, 0, 255));
      } else {
        // Turn off NeoPixel LED
  ...
  else if (led == 3)
  {
    ...
    if(fsm_mode) {
      // Turn off LED1 when FSM mode is enabled
      led1_state = false;
      digitalWrite(LED_GPIO, LOW);

      // Turn off NeoPixel LED when FSM mode is enabled
      neo_state = false;
      if (neoMutex && xSemaphoreTake(neoMutex, pdMS_TO_TICKS(50)) == pdTRUE) {
        neoStrip.setPixelColor(0, neoStrip.Color(0, 0, 0));
        neoStrip.show();
        xSemaphoreGive(neoMutex);
      }
  ...
  {
    tinyml_mode = !tinyml_mode;
  }

  server.send(200, "application/json",
              "{\"led1\":\"" + String(led1_state ? "ON" : "OFF") +
              "\",\"neo\":\"" + String(neo_state ? "ON" : "OFF") +
              "\",\"fsm\":\"" + String(fsm_mode ? "ON" : "OFF") +
              "\",\"tinyml\":\"" + String(tinyml_mode ? "ON" : "OFF") + "\"}");
}
...
void main_server_task(void *pvParameters)
{
  ...
  while (1)
  {
    ...
    // STA Mode
    Serial.printf("[main_server_task] connecting = %d\n", connecting);
    if (connecting)
    {
      Serial.println("[main_server_task] connecting is true. Attempting to connect to Wi-Fi...");
      ...
      if (WiFi.status() == WL_CONNECTED)
      {
        ...
        isAPMode = false;
        connecting = false;
        Serial.println("[main_server_task] Wi-Fi connected. connecting set to false.");
      }
      ...
      { // timeout 10s
        ...
        Serial.println("[main_server_task] Wi-Fi connection failed. connecting set to false.");
      }
    }
